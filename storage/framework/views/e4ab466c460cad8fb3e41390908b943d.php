<?php $__env->startSection('content'); ?>
    ...
    <div class="wrapper">
        <div class="container">
            ...
            <form action="<?php echo e(url('book-ticket')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="scheduleId" id="scheduleId" required
                                        ...
                                        <?php $__currentLoopData = $schedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option class="d-none" data-direction="<?php echo e($schedule->schedule_dir); ?>"
                                                value="<?php echo e($schedule->id); ?>"><?php echo e($schedule->trip_date); ?> -
                                                <?php echo e($schedule->departure_time); ?></option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="locationId" id="locationId"
                                        ...
                                        <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option class="d-none" data-selectprice="<?php echo e($location->ticket_price); ?>"
                                                data-direction="<?php echo e($location->root_direction); ?>" value="<?php echo e($location->id); ?>">
                                                <?php echo e($location->started_at); ?> to
                                                <?php echo e($location->ended_at); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                                <div class="mb-3">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Laravel\Projects from Git\module-12-main\resources\views/Ticket.blade.php ENDPATH**/ ?>